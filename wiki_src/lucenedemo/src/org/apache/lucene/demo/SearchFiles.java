...
public class SearchFiles {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //String[] field = {"title","redirect","contents"};
    String queries = null;
    int repeat = 0;
    boolean raw = false;
   ...
   //MultiFieldQueryParser parser = new MultiFieldQueryParser(Version.LUCENE_31, field, analyzer);
    ...
    while (true) {
      ...
      for (int i = start; i < end; i++) 
      {
          ...
          String path = doc.get("path");
             ...
             String title1 = path.substring(19,length - 4);	  
    	  
             
             for( int j=0;j<searchterms.length;j++)
             {
                 if(title1.equalsIgnoreCase(searchterms[j]))
                 {
      ...
      */
      ...
      for (int i = start; i < end; i++) {
        ...
        if (path != null) {
            ...
            FileWriter fstream = new FileWriter("D:\\lucene_300.txt",true);
